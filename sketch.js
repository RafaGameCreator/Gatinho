...
function preload() {
  ...
  obstacle1 = loadImage("dog.png");
  obstacle2 = loadImage("dog.png");
  obstacle3 = loadImage("dog.png");
  obstacle4 = loadImage("dog.png");
  obstacle5 = loadImage("dog.png");
  obstacle6 = loadImage("dog.png");
...
function draw() {
  ...
  if (gameState === PLAY) {
    ...
    if (touches.lenght > 0 || keyDown("space") && trex.isTouching(ground) && trex.y >= 159) {
      trex.velocityY = -12;
      touches = [];
    }
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(width, Math.round(random(100, 500)), 40, 10);
